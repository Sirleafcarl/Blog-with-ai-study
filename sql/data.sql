...
INSERT INTO `cheese`.`t_user` (`id`, `username`, `password`, `create_time`, `update_time`, `is_deleted`, `is_disabled`) VALUES (1, 'admin', '$2a$10$aGGgbab8HdmfxixuTwIYnOZxPH9hzrQuq1oRfLa91mVzSaRfgmtcu', '2023-07-03 11:57:18', '2023-07-08 08:24:36', 0, 0);
-- 游客 (登录账号/密码 : test/test)
INSERT INTO `cheese`.`t_user` (`id`, `username`, `password`, `create_time`, `update_time`, `is_deleted`, `is_disabled`) VALUES (2, 'test', '$2a$10$L6ce4rQsyJ1k7ZCOfN6X4e5dHLyvg2X0t9JFEZBezDq0lds79Pxja', '2023-07-07 01:22:05', '2023-07-07 01:22:05', 0, 0);

-- 博客基础设置信息（部署完成后，可自行登录管理后台更改）
INSERT INTO `cheese`.`t_blog_setting` (`blog_name`, `author`, `introduction`, `avatar`, `github_home`, `csdn_home`, `gitee_home`, `zhihu_home`) VALUES ('Cheese', 'Sirleaf', '神在原后面', 'https://img.sirleaf.com/sirleaf/2a5509abf8fe42118c17d6d18fb36a13.jpg', 'https://www.sirleaf.com', 'https://www.sirleaf.com', 'https://www.sirleaf.com', 'https://www.sirleaf.com');

-- 管理员角色
INSERT INTO `cheese`.`t_user_role` (`id`, `username`, `role`, `create_time`) VALUES (1, 'admin', 'ROLE_ADMIN', '2023-07-07 01:21:15');
-- 游客角色
INSERT INTO `cheese`.`t_user_role` (`id`, `username`, `role`, `create_time`) VALUES (2, 'test', 'ROLE_VISITOR', '2023-07-07 01:23:33');

-- ==================== 分类数据 ====================
INSERT INTO `cheese`.`t_category` (`id`, `name`, `create_time`, `update_time`, `is_deleted`) VALUES 
...
-- ==================== 标签数据 ====================
-- ==================== 标签数据 ====================
INSERT INTO `cheese`.`t_tag` (`id`, `name`, `create_time`, `update_time`, `is_deleted`) VALUES 
...
-- ==================== 文章数据 ====================
-- ==================== 文章数据 ====================
INSERT INTO `cheese`.`t_article` (`id`, `title`, `title_image`, `description`, `create_time`, `update_time`, `is_deleted`, `is_published`, `status`) VALUES 
...
-- ==================== 文章内容数据 ====================
INSERT INTO `cheese`.`t_article_content` (`article_id`, `content`) VALUES 
...
INSERT IGNORE INTO `cheese`.`t_article_category_rel` (`article_id`, `category_id`) VALUES
(1, 1),
(2, 3),
(3, 4),
(4, 5),
...
-- ==================== 文章-标签关联 ====================
-- ==================== 文章-标签关联 ====================
INSERT IGNORE INTO `cheese`.`t_article_tag_rel` (`article_id`, `tag_id`) VALUES
(1, 1), (1, 2),
(2, 4),
(3, 3),
(4, 5), (4, 6),
