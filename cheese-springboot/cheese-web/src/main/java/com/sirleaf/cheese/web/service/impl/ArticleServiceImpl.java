...
import com.sirleaf.cheese.common.enums.EventEnum;
import com.sirleaf.cheese.common.eventbus.ArticleEvent;
import com.sirleaf.cheese.common.exception.ResourceNotFoundException;
import com.sirleaf.cheese.web.convert.ArticleConvert;
import com.sirleaf.cheese.web.dao.*;
import com.sirleaf.cheese.web.model.vo.article.*;
import com.sirleaf.cheese.web.model.vo.category.QueryCategoryListItemRspVO;
import com.sirleaf.cheese.web.model.vo.tag.QueryTagListItemRspVO;
import com.sirleaf.cheese.web.service.ArticleService;
import com.sirleaf.cheese.web.utils.MarkdownUtil;
...
public class ArticleServiceImpl implements ArticleService {
    ...
    @Override
    public PageResponse searchArticle(com.sirleaf.cheese.web.model.vo.article.SearchArticleReqVO reqVO) {
        ...
        if (!CollectionUtils.isEmpty(records)) {
            ...
            list = list.stream().map(p -> {
                ...
                if (optional.isPresent()) {
                    ...
                    String categoryName = categoryIdNameMap.get(categoryId);
                    p.setCategory(com.sirleaf.cheese.web.model.vo.category.QueryCategoryListItemRspVO.builder()
